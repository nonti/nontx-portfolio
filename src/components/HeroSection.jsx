...
export const HeroSection = () => {
  return <section className="relative min-h-screen flex flex-col items-center justify-center">
    <div className="container z-10 mx-auto max-w-xl text-cnter">
      <div className="space-y-6">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-1">
          As a developer, I specialize in revampingwebsites for small startup companies. I take existing websites abd transform them into modern, user-friendly, and highly functional platforms. 
        </p>
